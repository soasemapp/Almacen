...
public class XMLInsertRece extends SoapSerializationEnvelope {
    ...
    public XMLInsertRece(int version) {
        super(version);
    }

    public void XMLInsertRecepcion(String usuario, String clave, String sucursal, String documento, String folio, String partidaP, String producto, String cantidad, String fecha, String hora, String UbicacionOri , String UbicacionDes) {
    ...
    public void write(XmlSerializer writer) throws IOException {
        ...
        writer.startTag(tem, "InsertReceRequest");
        ...
        writer.endTag(tem, "INSERREC");


        writer.endTag(tem, "InsertReceRequest");
