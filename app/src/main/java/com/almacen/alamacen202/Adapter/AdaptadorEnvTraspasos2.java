...
public class AdaptadorEnvTraspasos2 extends RecyclerView.Adapter<AdaptadorEnvTraspasos2.ViewHolderEnvTraspasos> {

    private ArrayList<EnvTraspasos> datos;
    private int index =-1;
    public AdaptadorEnvTraspasos2(ArrayList<EnvTraspasos> datos) {
        this.datos = datos;
    }//constructor

    @Override
    public AdaptadorEnvTraspasos2.ViewHolderEnvTraspasos onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_list_env_traspaso,
                null, false);
        return new AdaptadorEnvTraspasos2.ViewHolderEnvTraspasos(view);
    }//oncreateViewHolder

    @Override
    public void onBindViewHolder(AdaptadorEnvTraspasos2.ViewHolderEnvTraspasos holder, int position) {
        ...
        holder.tvItemE.setVisibility(View.GONE);
